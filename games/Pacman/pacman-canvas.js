...
/* ----- Global Variables ---------------------------------------- */
	...
	function updateDBscore(score){
	    var lastScore = score;
	    $.post("getscore.php", {userScore: lastScore});
	}
	...
	function pacman() {
		...
		this.dieFinal = function() {
	    	...
	    	if (this.lives <= 0) {
				...
				var home = '</br><a href="../../"><i class="fa fa-home fa-4x" style="color:white;"></i></a>';
				game.showMessage("Game over","Total Score: "+game.score.score+home);
				var theScore = game.score.score;
				updateDBscore(theScore);
				game.gameOver = true;
				$('#playerName').focus();
				}
